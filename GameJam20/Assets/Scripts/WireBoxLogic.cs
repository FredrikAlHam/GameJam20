public class WireBoxLogic
{
    public static bool CheckWire(int origin, int dest, string color, int count)
    {
        if (count == 3)
        {
            if (color == "red")
            {
                if (origin == 1 && dest == 5 || origin == 2 && dest == 3 || origin == 3 && dest == 2 || origin == 4 && dest == 10 || origin == 5 && dest == 11 || origin == 6 && origin == 12) return true;
            }
        ...
        if (count == 5)
        {
            ...
            if (color == "blue") if (origin == 1 && dest == 3 || origin == 2 && dest == 2 || origin == 3 && dest == 1 || origin == 4 && dest == 4 || origin == 5 && dest == 5) return true;
            if (color == "green") if (origin == 1 && dest == 2 || origin == 2 && dest == 1 || origin == 3 && dest == 3 || origin == 4 && dest == 5 || origin == 5 && dest == 4) return true;
